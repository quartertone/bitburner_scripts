...
export const settings = {
  ...
  serverinfo:"check-getinfo.js",

  batchbuffer: 600,

  sleeve: {
    classic: "sleeve-actions-classic.js",
    company: "sleeve-actions-company.js",
    crime: "sleeve-actions-crime.js",
    gym: "sleeve-actions-gym.js",
    recovery: "sleeve-actions-recovery.js",
    synchro: "sleeve-actions-synchro.js"
  },

  primary: {
    buy_betterstocks: "buy-betterstocks.js",
    graft: "graft.js",
    batch_install: "batch-install.js",
    sleeve_tasks: "sleeve-tasks.js",
    corpcontrol: "corpcontrol.js",
    loopinstall: "loop-install.js",
    scanhosts: "scanhosts.js",

    sing_getapps: "sing-getapps.js",
    buy_stockaccess: "buy-stockaccess.js",
    //hacknetcorp:"hacknetcorp.js",
    sleeve_task: "sleeve-task.js",
    gangsame: "gangsame.js",

  },

  tix: {
    runfile: "stockscript-runfile.txt",
    tracker: "check-moneystocks.js",
    info: "check-stockinfo.js"
  },


  end: {
    singularity: "0-singularity.js"
  },
...
export async function loopinstall(ns, server, opts) {
  ...
  while (ns.scriptRunning(settings.primary.loopinstall, "home") && freeram < scriptram) { // hang on a minute if we're temp out of ram
    await ns.sleep(1000);
  }
  try {
